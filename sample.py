...
from keras.layers import CuDNNLSTM, Dropout, TimeDistributed, Dense, Activation, Embedding
...
def build_sample_model(vocab_size):
    ...
    for i in range(3):
        model.add(CuDNNLSTM(256, return_sequences=(i != 2), stateful=True))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--len', type=int, default=1024, help='number of characters to sample (default 512)')
